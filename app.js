...
const checkRequestQueryParameters = async (request, response, next) => {
...
//Get Todos API-1
app.get("/todos/", checkRequestQueryParameters, async (request, response) => {
  const {
    status = "",
    search_q = "",
    priority = "",
...
//GET Agenda API-3
app.get("/agenda/", checkRequestQueryParameters, async (request, response) => {
  const { date } = request;
  console.log(date, "a");
